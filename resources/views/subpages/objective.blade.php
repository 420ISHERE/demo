...
<div class="container-fluid page-header py-5 mb-5 ">
    <div class="container text-center py-5">
        <h1 class="display-3 mb-4 " style="color: #1c92dd;">Our Objective</h1>
...
<div class="container-md">
    <div class="row">
        <div class="col-md-11 mx-auto">
            <h2 class="fs-5">HKM Dehradun is a charitable society with the following objectives:</h2>
        </div>
    </div>

    <div class="row">
        <div class="col-md-11 mx-auto">
            <h3 class="fs-5 my-3" style="color:#239fdb">Spreading the Holy Name</h3>
        </div>
    </div>
    <div class="row my-3">
        <div class="col-md-11 mx-auto">
            <img class="img-fluid rounded" width=800 src="https://hkmdehradun.org/assets/images/spreading-the-holy-name.jpg" alt="mission image">
        </div>
    </div>
    <div class="row my-3">
        <div class="col-md-11 mx-auto">
    ...
    <div class="row">
        <div class="col-md-11 mx-auto">
            <h3 class="fs-5 my-3" style="color:#239fdb">Gorgeous Deity-Worship and Opulent Festivals</h3>
        </div>
    </div>
    <div class="row my-3">
        <div class="col-md-11 mx-auto">
            <img class="img-fluid rounded" width=800 src="https://hkmdehradun.org/assets/images/deity-worship.jpg" alt="mission image">
        </div>
    </div>
    <div class="row my-3">
        <div class="col-md-11 mx-auto">
    ...
    <div class="row">
        <div class="col-md-11 mx-auto">
            <h3 class="fs-5 my-3" style="color:#239fdb">Create Awareness about Srila Prabhupada</h3>
        </div>
    </div>
    <div class="row my-3">
        <div class="col-md-11 mx-auto">
            <img class="img-fluid rounded" width=800 src="https://hkmdehradun.org/assets/images/srila-prabhupada-awerness.jpg" alt="mission image">
        </div>
    </div>
    <div class="row my-3">
        <div class="col-md-11 mx-auto">
    ...
    <div class="row">
        <div class="col-md-11 mx-auto">
            <h3 class="fs-5 my-3" style="color:#239fdb">Distribution of Scriptures</h3>
        </div>
    </div>
    <div class="row my-3">
        <div class="col-md-11 mx-auto">
            <img class="img-fluid rounded" width=800 src="https://hkmdehradun.org/assets/images/distribution-of-scriptures.jpg
            " alt="mission image">
        </div>
    </div>
    <div class="row my-3">
    ...
    <div class="row">
        <div class="col-md-11 mx-auto">
            <h3 class="fs-5 my-3" style="color:#239fdb">Missionary Development</h3>
        </div>
    </div>
    <div class="row my-3">
        <div class="col-md-11 mx-auto">
            <img class="img-fluid rounded" width=800 src="https://hkmdehradun.org/assets/images/monk.jpg
            " alt="mission image">
        </div>
    </div>
    <div class="row my-3">
    ...
    <div class="row">
        <div class="col-md-11 mx-auto">
            <h3 class="fs-5 my-3" style="color:#239fdb">Resource Mobilization</h3>
        </div>
    </div>
    <div class="row my-3">
        <div class="col-md-11 mx-auto">
            <img class="img-fluid rounded" width=800 src="https://hkmdehradun.org/assets/images/fund-raising.jpg
            " alt="mission image">
        </div>
    </div>
    <div class="row my-3">
    ...
    <div class="row">
        <div class="col-md-11 mx-auto">
            <h3 class="fs-5 my-3" style="color:#239fdb">To increase Krishna Consciousness</h3>
        </div>
    </div>
    <div class="row my-3">
        <div class="col-md-11 mx-auto">
            <img class="img-fluid rounded" width=800 src="https://hkmdehradun.org/assets/images/increase-krishna-consciousness.jpg
            " alt="mission image">
        </div>
    </div>
    <div class="row my-3">
    ...
    <div class="row">
        <div class="col-md-11 mx-auto">
            <h3 class="fs-5 my-3" style="color:#239fdb">Special Purpose Enterprises</h3>
        </div>
    </div>
    <div class="row my-3">
        <div class="col-md-11 mx-auto">
            <img class="img-fluid rounded" width=800 src="https://hkmdehradun.org/assets/images/devotional-item.jpg
            " alt="mission image">
        </div>
    </div>
    <div class="row my-3">
    ...
    <div class="row">
        <div class="col-md-11 mx-auto">
            <h3 class="fs-5 my-3" style="color:#239fdb">Upcoming VCM Project</h3>
        </div>
    </div>
    <div class="row my-3">
        <div class="col-md-11 mx-auto">
            <img class="img-fluid rounded" width=800 src="https://hkmdehradun.org/assets/images/projects.jpg
            " alt="mission image">
        </div>
    </div>
    <div class="row my-3">
    ...
    <div class="row">
        <div class="col-md-11 mx-auto">
            <h3 class="fs-5 my-3" style="color:#239fdb">Life in Harmony with Nature</h3>
        </div>
    </div>
    <div class="row my-3">
        <div class="col-md-11 mx-auto">
            <img class="img-fluid rounded" width=800 src="https://hkmdehradun.org/assets/images/harmony-with-nature.jpg
            " alt="mission image">
        </div>
    </div>
    <div class="row my-3">
    ...
    <div class="row">
        <div class="col-md-11 mx-auto">
            <h3 class="fs-5 my-3" style="color:#239fdb">Prasadam Distribution</h3>
        </div>
    </div>
    <div class="row my-3">
        <div class="col-md-11 mx-auto">
            <img class="img-fluid rounded" width=800 src="https://hkmdehradun.org/assets/images/prasadam-distribution.jpg
            " alt="mission image">
        </div>
    </div>
    <div class="row my-3">
        <div class="col-md-11 mx-auto">
            <p class="text-justify lh-lg">
                Food distribution is considered to be the supreme of all charities. Srila Prabhupada wanted everyone to taste the nectar of devotion. The food that is offered to Krishna is considered the divine nectar that can alleviate our suffering by freeing us from sins. Srila Prabhupada insisted that everyone who visits the temple must get some prasadam. We have been distributing kichadi prasadam to every visitor since the inception of the temple and in the year 2015 we have also started the Nitya Annadana program which provides sumptuous lunch prasadam to visitors every day from 11:30 am to 2:00 pm.
                <br>
                We practice sustainable and socially responsible practices in achieving the above objectives.
            </p>
        </div>
    </div>
