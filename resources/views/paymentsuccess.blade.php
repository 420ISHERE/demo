        ...
        <div class="child_container">
             ...
             <div class="payment-details">
                ...
                <div class="donar-details">
                    <div class="donor name"><div><h2>Name</h2></div> <div><p>{{$name}} </p></div></div>
                    <div class="donor mobile"><div><h2>Mobile</h2></div> <div><p> {{$mobile}}</p></div></div>
                    <div class="donor amount"><div><h2>Amount</h2></div> <div><p><b>₹ {{$amount}} /-</b></p></div></div>
                    <div class="donor payid"><div><h2>Transaction ID</h2></div> <div><p> {{$payID}}</p></div></div>
