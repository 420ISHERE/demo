    ...
    <div class="main_container">
        <div class="child_container">
             ...
             <div class="payment-details">
                <div style="text-align: center;"> <i class="fa fa-times-circle" aria-hidden="true" style="font-size: 32px;color: red;"></i></div>
               
                <div class="title-section"><h3 style="color:red;margin-top:10px;">Payment Failed</h3>
                    <h4 >Thank you for attempting to register</h4>
                </div>
                ...
                <div class="btn-home"><a href="https://hkmdehradun.org/icvk-registration"><button>Try Again</button></a></div>
