...
<script>
  ...
  var options = {
    ...
    "description": "ICVK Youth",
    "image": "https://hkmdehradun.org/assets/images/hkmdrazorpay.jpg",
    "order_id": "{{$data->id}}",
    "handler": function(response) {

      console.log(response)
      window.location.href = "{{route('icvk.payment.status')}}" + '?payment_id=' + response
        .razorpay_payment_id;
  ...
  rzp1.on('payment.failed', function(response) {
    window.location.href = "https://hkmdehradun.org/icvk-registration-failure"
  });
