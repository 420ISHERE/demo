    ...
    <div id="carouselExampleCaptions" class="carousel slide carousel-fade" data-bs-ride="false">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="hkm assets/festival_banner7178719-Photoroom.jpg" class="d-block w-100" alt="..."
                    style="height: 350px; object-fit: cover;">

            </div>
            <div class="carousel-item">
                <img src="hkm assets/10/banner_1437335.jpg" class="d-block w-100" alt="..."
                    style="height: 350px; object-fit: cover;">

            </div>
            <div class="carousel-item">
                <img src="hkm assets/banner_2071500-Photoroom.jpg" class="d-block w-100" alt="..."
                    style="height: 350px; object-fit: cover;">
