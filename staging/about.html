...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top px-4 px-lg-5">
        <a href="index.html" class="navbar-brand d-flex align-items-center">
            <img src="hkm assets/10/HKM-Dehradun-Logo-1024x617.jpg" alt="" style="height: 68px;">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="product.html" class="nav-item nav-link">Our Centers</a>
            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.3s">
                    <div class="row g-4 align-items-center">
                        <div class="col-sm-4">
                            <img class="img-fluid rounded" src="hkm assets/Capture.JPG" alt="">
                        </div>
                        <div class="col-sm-8">
            ...
            <div class="row g-5">
                <div class="col-lg-4 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>
                        Plot No.33, Vasant Vihar, Phase II, DVOCHSL, Dehradun 248006, Uttarakhand</p>
                    <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+91 8121151508
                    </p>
                    <p class="mb-2"><i class="fa fa-envelope me-3"></i>contact@hkmdehradun.in</p>
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <a class="btn btn-link" href="">Cancellation & Refund Policy</a>
                </div>
                <!-- <div class="col-lg-4 col-md-6">
